...
- [ ] **Phase 1: Container Foundation** - AgentContainer base with lifecycle state machine, context, memory store, health self-reporting, child specs, and communication contract

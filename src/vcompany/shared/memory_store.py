...
Migrated from container/memory_store.py to shared/memory_store.py as part of
dead code cleanup (Phase 34). MemoryStore is used by the scheduler, backlog,
and project state -- shared infrastructure, not container-specific.

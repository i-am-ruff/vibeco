...
Migrated from container/health.py to supervisor/health.py as part of
dead code cleanup (Phase 34). These types are used by the supervision
tree and daemon, not by the container runtime.
"""

...
Migrated from container/child_spec.py to supervisor/child_spec.py as part of
dead code cleanup (Phase 34). These types are used by the supervision tree,
not by the container runtime.
...
class ContainerContext(BaseModel):
    ...
    Fields:
        ...
        uses_tmux: Whether this agent runs in a tmux pane.
    """
